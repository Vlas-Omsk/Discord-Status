...
namespace WEBLib
{
    class WEB
    {
        ...
        public static string Post(string url, string[] headers = null, byte[] data = null, string method = "POST")
        {
    ...
    {
        public static string ToString(this WebHeaderCollection headers)
        {
            string res = "";
